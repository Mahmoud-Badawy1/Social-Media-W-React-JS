...
// //             <ul>
// //                             {Object.entries(postedContent).map(([timestamp, content]) => (
...
// export default Post
>>>>>>> 76827da739d0d50560f033d8bde97bbf952c4160


/* eslint-disable no-unused-vars */
import React from 'react'

function Post({ postedContent }) {
    return (
        <div className=' bg-[#fff6df] w-2/4 px-6 py-4 rounded-3xl drop-shadow-md m-6'>
            <div className=' flex justify-between'>
                <div className=' flex'>
...
<<<<<<< HEAD
=======
                    {/* Iterate over postedContent object */}
>>>>>>> 76827da739d0d50560f033d8bde97bbf952c4160
                    {Object.entries(postedContent).map(([timestamp, content]) => (
                        <li key={timestamp}>{content}</li>
                    ))}
